...
{
	return (uint32_t)(SERIAL_BUFFER_SIZE + rx_buffer->rx_Head - rx_buffer->rx_Tail) % SERIAL_BUFFER_SIZE; 
}
/**********************************************************************
name :
function : 
...
int UARTClass::read( void )
{
	...
	uint8_t dat = rx_buffer->_aucBuffer[rx_buffer->rx_Tail];
	rx_buffer->rx_Tail = (unsigned int)(rx_buffer->rx_Tail + 1) % SERIAL_BUFFER_SIZE;
...
int UARTClass::peek( void )
{
	...
	return rx_buffer->_aucBuffer[rx_buffer->rx_Tail];
}
/**********************************************************************
name :
function : 
