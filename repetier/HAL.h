...
#define F_CPU_TRUE  	VARIANT_MCK        // actual CPU clock frequency
...
/*krix already defined in avr/pgmspace.h
#define PROGMEM
...
#if defined(ARDUINO) //krix && ARDUINO >= 100
#include "../arduino/Arduino.h"
#else
#include "WProgram.h"
#define COMPAT_PRE1
...
#define OUT_P_I(p,i) //Console::printF(PSTR(p),(int)(i))
#define OUT_P_I_LN(p,i) //Console::printFLN(PSTR(p),(int)(i))
#define OUT_P_L(p,i) //Console::printF(PSTR(p),(long)(i))
#define OUT_P_L_LN(p,i) //Console::printFLN(PSTR(p),(long)(i))
#define OUT_P_F(p,i) //Console::printF(PSTR(p),(float)(i))
#define OUT_P_F_LN(p,i) //Console::printFLN(PSTR(p),(float)(i))
#define OUT_P_FX(p,i,x) //Console::printF(PSTR(p),(float)(i),x)
#define OUT_P_FX_LN(p,i,x) //Console::printFLN(PSTR(p),(float)(i),x)
#define OUT_P(p) //Console::printF(PSTR(p))
#define OUT_P_LN(p) //Console::printFLN(PSTR(p))
#define OUT_ERROR_P(p) //Console::printErrorF(PSTR(p))
#define OUT_ERROR_P_LN(p) {//Console::printErrorF(PSTR(p));//Console::println();}
#define OUT(v) //Console::print(v)
#define OUT_LN //Console::println()
