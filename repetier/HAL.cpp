...
void HAL::showStartReason() {
    ...
    switch (mcu){
    case 0:
        Console::printInfoFLN(Messages::tPowerUp);
        break;
    case 1:
        // this is return from backup mode on SAM
        Console::printInfoFLN(Messages::tBrownOut);
    case 2:
        Console::printInfoFLN(Messages::tWatchdog);
        break;
    case 3:
        Console::printInfoFLN(Messages::tSoftwareReset);
        break;
    case 4:
        Console::printInfoFLN(Messages::tExternalReset);
    } 
}
