...
public:
    ...
    static inline void setRodRadius(float mm) {
      ...
      Console::printFLN(PSTR("Rod Radius set to: "),mm,3);
    ...
    static inline void setTowerXFloor(float newZ) {
      ...
      Printer::xMin = newZ;
      Printer::updateDerivedParameter();
      Console::printFLN(PSTR("X (A) tower floor set to: "),Printer::xMin,3);
#if EEPROM_MODE != 0
...
static inline void setTowerYFloor(float newZ) {
      ...
      Printer::yMin = newZ;
      Printer::updateDerivedParameter();
      Console::printFLN(PSTR("Y (B) tower floor set to: "),Printer::yMin,3);
#if EEPROM_MODE != 0
...
static inline void setTowerZFloor(float newZ) {
      ...
      Printer::zMin = newZ;
      Printer::updateDerivedParameter();
      Console::printFLN(PSTR("Z (C) tower floor set to: "),Printer::zMin,3);
#if EEPROM_MODE != 0
